...
int32_t nsocket_closer(void* h, int32_t fd, int8_t* b, int32_t sz, void* moreinfo, void* o)
{
...
int32_t nsocket_write(void* h, int32_t fd, int8_t* b, int32_t sz, void* moreinfo, void* o)
{
  int32_t e = 0;
  cnsocket* p = (cnsocket*)o;
...
int32_t nsocket_connected(void* h, int32_t fd, int8_t* b, int32_t sz, void* moreinfo, void* o)
{
  cnsocket* p = (cnsocket*)o;

  return p->io.__f[IMTIF_CALLBACK_CONNECTED]?p->io.__f[IMTIF_CALLBACK_CONNECTED](h, fd, b, sz, moreinfo, o):__zero();
}

int32_t nsocket_disconnected(void* h, int32_t fd, int8_t* b, int32_t sz, void* moreinfo, void* o)
{
  cnsocket* p = (cnsocket*)o;

  return p->io.__f[IMTIF_CALLBACK_DISCONNECTED]?p->io.__f[IMTIF_CALLBACK_DISCONNECTED](h, fd, b, sz, moreinfo, o):__zero();
}


int32_t nsocket_read(void* h, int32_t fd, int8_t* b, int32_t sz, void* moreinfo, void* o)
{
  cnsocket* p = (cnsocket*)o;

  return p->io.__f[IMTIF_CALLBACK_READ]?p->io.__f[IMTIF_CALLBACK_READ](h, fd, b, sz, moreinfo, o):__zero();
}
