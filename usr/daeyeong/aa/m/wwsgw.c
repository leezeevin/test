...
void* wsgWebSocketStatus(void* t,int fd, unsigned char* b, int sz, void* mi, int err, void* o)
{
  int e = 0;
...
void* wsgWebSocketRead(void* t,int fd, unsigned char* b, int sz, void* mi, int err, void* o)
{
  char st[32];
  char rbuf[4096];
  char vbuf[4096];
...
void* wsgSocketStatus(void* t,int fd, unsigned char* b, int sz, void* mi, int err, void* o)
{
  int e = 0;
  int idx = (mi==0)?0:(*(int*)mi);
...
void* wsgSocketRead(void* t,int fd, unsigned char* b, int sz, void* mi, int err, void* o)
{
  char st[32];
  int osz = 0;
  char rbuf[1024];
