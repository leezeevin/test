...
int32_t nsocket_opened(void* h, int32_t fd, int8_t* b, int32_t sz, void* extra, void* o)
{
  cnsocket* p = (cnsocket*)o;
...
int32_t nsocket_closed(void* h, int32_t fd, int8_t* b, int32_t sz, void* extra, void* o)
{
  cnsocket* p = (cnsocket*)o;
...
int32_t nsocket_open(cnsocket* p)
{
  ...
  p->_imtif.callback[IMTIF_CALLBACK_OPEN] = nsocket_opened;
  p->_imtif.callback[IMTIF_CALLBACK_CLOSE] = nsocket_closed;
...
int32_t nsocket_close(cnsocket* p)
{
  ...
  e = __socket_close(&p->_imtif.h);

  p->_imtif.callback[IMTIF_CALLBACK_OPEN] = 0;
  p->_imtif.callback[IMTIF_CALLBACK_CLOSE] = 0;
  p->_imtif.callback[IMTIF_CALLBACK_CONNECTED] = 0;
  p->_imtif.callback[IMTIF_CALLBACK_DISCONNECTED] = 0;
  p->_imtif.callback[IMTIF_CALLBACK_READ] = 0;
