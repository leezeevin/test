...
#include <dbgbuffer.h>
#include "../../../lite.io.examples/cCrypto32/kisa_key.h"
...
void kisa_ctr_drbg_test()
{
  ...
  e = KISA_CTR_DRBG_Instantiate(&state, ALGO_SEED, entropy1, sz[0], nonce1, nonce1_sz, pstr,  pstr_sz, 0);
