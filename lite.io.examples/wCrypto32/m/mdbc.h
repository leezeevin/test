...
#define DB_HOST    TEXT("1.246.219.218")
#define DB_USER    TEXT("MANANDTEL")
#define DB_PASS    TEXT("aosdpsxpf")
#define DB_NAME    TEXT("smart_factory_upper")
#define DB_PORT    TEXT("3306")
