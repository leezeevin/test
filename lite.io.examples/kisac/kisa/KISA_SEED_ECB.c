/// From githug/projectX
/// From githug/projectX  - B
...
void main_kisa_seed_ecb()
{
	DWORD pdwRoundKey[32] = {0 };														// Round keys for encryption or decryption
	...
	BYTE pbData[32]    = {0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 		// input plaintext to be encrypted
                        0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F,
												0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 		// input plaintext to be encrypted
												0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F};
	int i;
	int sz = 32;
	...
	for ( i=10 ;i<16 ; i++ )
	{
		pbUserKey[i] = 0x41 - 10 + i;
	}

	for ( i=0 ;i<10 ; i++ )
	{
		pbData[i+16] = pbData[i] = 0x30+i;
	}
	for ( i=10 ;i<16 ; i++ )
	{
		pbData[i+16] = pbData[i] = 0x41-10+i;
	}
