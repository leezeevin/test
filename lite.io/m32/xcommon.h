...
#if __MODULE_NAME__
static const int8_t MODULE_NAME[] =
#include ".module"
;
#endif
...
extern "C"
#endif
int32_t __base64_decode(int8_t* in, int32_t sz, int8_t* out);
...
extern "C"
#endif
int32_t __base64_encode(int8_t* in, int32_t sz, int8_t* out);
...
extern "C"
#endif
int8_t* __curr_time(int8_t*p, int8_t* arg0, int8_t* arg1, int8_t* arg2, int8_t* arg3, int32_t* YY, int32_t* MM, int32_t* DD, int32_t* hh, int32_t* mm, int32_t* ss, int32_t* us);
#endif
...
extern "C"
#endif
int8_t* ____gmtime(void* tm, int8_t* s);
#endif
...
extern "C"
#endif
int32_t __padding(int32_t n, int32_t m);
...
extern "C"
#endif
uint8_t __to_8bit(uint8_t* txt, uint8_t* b);
...
extern "C"
#endif
int32_t __mosaic(int8_t* img, int8_t* hdr, int32_t x, int32_t y, int32_t w, int32_t h, int8_t** raw);
...
extern "C"
#endif
int32_t __pick_mosaic_bitmap(int8_t* src, int32_t x, int32_t y, int32_t w, int32_t h, int8_t** dst);


#if defined __cplusplus
extern "C"
#endif
int32_t __read_raw(int8_t r, int8_t* bmp, int32_t* xy, int32_t* wh, int8_t** raw);

#if defined __cplusplus
extern "C"
#endif
int32_t __pick_pixel(int8_t* bmp, int32_t* xy, int8_t** raw);
...
extern "C"
#endif
int32_t __write_raw(int8_t r, int8_t* raw, int32_t* wh, int32_t bcnt, int8_t* bmp);
...
extern "C"
#endif
int64_t __prime_factor_set(int64_t p, int64_t* ps, int64_t sz, int64_t* rs);
...
extern "C"
#endif
int64_t __prime_factors(int64_t p, int64_t* rs);
...
//#endif
//#endif
//int64_t __common_divisor(int64_t n, int64_t* cd);
...
extern "C"
#endif
int64_t __divisors(int64_t n, int64_t* p);
...
extern "C"
#endif
int64_t __common_divisor(int64_t* n, int64_t* p, int64_t* gl);
...
extern "C"
#endif
uint64_t ____exp(int64_t b, int64_t exp, int64_t m);
...
extern "C"
#endif
void fprintMatrix(long double* mtrx,int8_t* rc,long double mod,int8_t* o,const int8_t* fmt,...);
...
extern "C"
#endif
uint8_t __noiz(uint32_t who);

#if defined __cplusplus
extern "C"
#endif
int32_t __noise(int32_t who, uint8_t* o, int32_t sz_bit);
...
extern "C"
#endif
int32_t __deserialize_bitmap(int8_t* raw, int32_t *wh, int32_t bcnt, int32_t padding, uint8_t* seq, int8_t* bmp);
