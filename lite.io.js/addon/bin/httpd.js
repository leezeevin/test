...
var wsd = require('./liteio_wsd_ha64');


let req_method = "";

var shm_fd = shm.open("--shm_key 7810 --shm_size 8192", shm_callback);
var httpd_fd = httpd.open("--httpd_port 80 --httpd_home /opt/www --httpd_index index.html", httpd_callback);
var srl_fd = srl.open("--serial_port /dev/ttyAMA1 --serial_baudrate 9600 --serial_size_of_buffer 64", serial_callback);
...
{
  console.log('wsd_callback ', fd, type);
  //console.log("+##############################################################################+");
