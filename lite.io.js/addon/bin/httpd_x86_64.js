var httpd = require('./liteio_httpd_x86_64');
var shm = require('./liteio_shm_x86_64');
var srl = require('./liteio_serial_x86_64');
var wsd = require('./liteio_wsd_x86_64');

let req_method = "";

var httpd_fd = httpd.open("--httpd_port 8083 --httpd_home D:\\waas\\htdocs --httpd_index index.html", httpd_callback);
