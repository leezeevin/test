...
extern "C"
#endif
int32_t nserial_closer(void* h, int32_t fd, int8_t* b, int32_t sz, void* moreinfo, void* o);


#if defined __cplusplus
extern "C"
#endif
int32_t nserial_writer(void* h, int32_t fd, int8_t* b, int32_t sz, void* moreinfo, void* o);
