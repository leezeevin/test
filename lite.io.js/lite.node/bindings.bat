...
if "%MODULE%" == "socket" (
  @set DEBUG_FLAGS=%DEBUG_FLAGS%"__NSOCKET__=1",
) else (
  @set DEBUG_FLAGS=%DEBUG_FLAGS%"__NSOCKET__=0",
)

if "%MODULE%" == "websocket" (
  @set DEBUG_FLAGS=%DEBUG_FLAGS%"__NWEBSOCKET__=1",
) else (
  @set DEBUG_FLAGS=%DEBUG_FLAGS%"__NWEBSOCKET__=0",
)
...
@set BINDING=%BINDING%"./nxx/__nLite.c",
@set BINDING=%BINDING%"./../../lite.io/__nio/__nhttpd.c",
@set BINDING=%BINDING%"./../../lite.io/__nio/__nserial.c",
@set BINDING=%BINDING%"./../../lite.io/__nio/__nsocket.c",
@set BINDING=%BINDING%"./../../lite.io/__nio/__nwebsocket.c",
@set BINDING=%BINDING%"./../../lite.io/__nio/__util.c",
@set BINDING=%BINDING%],
@set BINDING=%BINDING%"include_dirs" : [
@set BINDING=%BINDING%"./",
@set BINDING=%BINDING%"./nxx",
@set BINDING=%BINDING%"./../../lite.io/__nio/",
...
@set BINDING=%BINDING%"__WEBSOCKET__=1",
